...
- Use proper HTML formatting (h2, h3, p, ul, li)
- 600-800 words
...
`;
    ...
    const response = await ollama.chat({
      model: "gemma:2b", // you can change model
      messages: [
        {
          role: "user",
          content: prompt,
...
`;
    ...
    const improvedContent = response.message.content;
    ...
    console.error("Ollama Improve Error:", error);
    return {
      success: false,
